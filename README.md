...
##
Atuamente estudando a área de dados 🎲!

- 🎯 Foco em **Ciência de Dados** com Python e SQL
- 🐍 Estudando **Python, Pandas e NumPy** para análise de dados
- 🗄️ Aprendendo **SQL** para manipulação e consulta de dados
- 📚 Sempre evoluindo com projetos práticos
- 💼 Em busca de **estágio em dados**
